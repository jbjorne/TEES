bash ~/cvs_checkout/GeniaChallenge/triggerRecognition/jari-triggers-for-devel.sh $1 $2 $3
...
bash ~/cvs_checkout/GeniaChallenge/triggerRecognition/jari-edges-from-predicted-entities.sh $1 $2 $3