...
optparser.add_option("-m", "--triggerModel", default=Settings.EverythingTriggerModel, dest="triggerModel", help="SVM-multiclass trigger model")
optparser.add_option("-n", "--edgeModel", default=Settings.EverythingEdgeModel, dest="edgeModel", help="SVM-multiclass edge (event argument) model")
