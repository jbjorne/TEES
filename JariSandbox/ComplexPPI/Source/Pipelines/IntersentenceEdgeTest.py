...
from ExampleBuilders.IntersentenceEdgeExampleBuilder import IntersentenceEdgeExampleBuilder
...
# Example builders
optparser.add_option("-f", "--edgeExampleBuilder", default="IntersentenceEdgeExampleBuilder", dest="edgeExampleBuilder", help="")
optparser.add_option("-s", "--styles", default="trigger_features,typed,directed,no_linear,entities,co_limits,noMasking,maxFeatures", dest="edgeStyles", help="")
...
optparser.add_option("-x", "--edgeParams", default="1,10,100,1000,2000,3000,4000,5000,6000,7000,8000,10000,20000", dest="edgeParams", help="Trigger detector c-parameter values")
...
e = EdgeExampleWriter()
e.removeEdges = False
edgeXML = e.writeXML(EDGE_TEST_EXAMPLE_FILE, "edge-test-classifications", TEST_FILE, "test-predicted-edges.xml", EDGE_IDS+".class_names", PARSE, TOK)
