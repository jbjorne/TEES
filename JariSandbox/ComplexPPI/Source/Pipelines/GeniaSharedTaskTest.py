...
#TRIGGER_TEST_EXAMPLE_FILE=TRIGGER_EXAMPLEDIR+"/trigger-devel-examples-"+PARSE_TOK
#TRIGGER_EVERYTHING_EXAMPLE_FILE=TRIGGER_EXAMPLEDIR+"/trigger-train-examples-"+PARSE_TOK
...
EDGE_EVERYTHING_EXAMPLE_FILE=EDGE_EXAMPLEDIR+"/edge-everything-examples-"+PARSE_TOK
#EDGE_TEST_EXAMPLE_FILE=EDGE_EXAMPLEDIR+"/edge-devel-examples-"+PARSE_TOK
