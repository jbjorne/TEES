...
TRAIN_EXAMPLE_FILE=EXAMPLEDIR+"/trigger-train-examples-"+PARSE
DEVEL_EXAMPLE_FILE=EXAMPLEDIR+"/trigger-devel-examples-"+PARSE
CLASS_NAMES=EXAMPLEDIR+"/bioinfer-trigger-ids.class_names"
WORKDIR="/usr/share/biotext/UnmergingProject/results/parameters/triggers-"+PARSE
