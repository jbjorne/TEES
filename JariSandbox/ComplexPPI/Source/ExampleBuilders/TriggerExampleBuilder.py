...
# release package. The GeneralEntityTypeRecognizerGztr had already evolved beyond
# what's in the Computational Intelligence paper
#ENDIF
...
class TriggerExampleBuilder(ExampleBuilder):
    ...
    def run(cls, input, output, parse, tokenization, style, idFileTag=None, gazetteerFileName=None):
        ...
        e = TriggerExampleBuilder(style, classSet, featureSet, gazetteerFileName)
        if "names" in style:
