...
import networkx
from networkx_v099.utils import is_string_like
...
def disjoint_union(G,H):
    ...
    R2=convert_node_labels_to_integers(H,first_label=networkx_v099.number_of_nodes(R1))
    R=union(R1,R2)
