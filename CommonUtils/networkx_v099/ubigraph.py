...
from networkx_v099.classes.multigraph import MultiGraph
from networkx_v099.classes.multidigraph import MultiDiGraph
from networkx_v099.exception import NetworkXException, NetworkXError
import networkx_v099.convert as convert

class UbiGraph(MultiGraph):
    """
Base classes for interaction between Networkx_v099 and Ubigraph.

These classes allow drawing with Ubigraph and all of the Networkx_v099 functions.
...
->>> G=nx.UbiGraph(networkx_v099.cycle_graph(5)) # cycle of length 5

See the examples 
https://networkx_v099.lanl.gov/browser/networkx/trunk/doc/examples/ubigraph

UbiGraph 
--------
Networkx_v099 compatible graph class.  Allows self loops and multiple edges.  
Extends to Networkx_v099 MultiGraph class. 

UbiDiGraph 
--------
Networkx_v099 compatible digraph class.  Allows self loops and multiple edges.  
Extends Networkx_v099 MultiDiGraph class. 

Ubigraph attributes
--------------------
In addition to all of the XGraph and XDiGraph methods and Networkx_v099 functions
