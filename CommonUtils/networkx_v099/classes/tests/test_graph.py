...
class TestGraph:
    ...
    def setUp(self):
        self.Graph=networkx_v099.Graph
        # build K3
    ...
    def test_getitem(self):
        ...
        assert_raises((TypeError,networkx_v099.NetworkXError), G.__getitem__, ['A'])
    ...
    def test_remove_node(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.remove_node,-1)
    ...
    def test_add_edges_from(self):
        ...
        G.add_edges_from([(0,1),(0,2,3)],data=2)
        assert_raises(networkx_v099.NetworkXError, G.add_edges_from,[(0,)])  # too few in tuple
        assert_raises(networkx_v099.NetworkXError, G.add_edges_from,[(0,1,2,3)])  # too many in tuple
    ...
    def test_remove_edge(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.remove_edge,-1,0)
    ...
    def test_neighbors(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.neighbors,-1)

    def test_neighbors_iter(self):
        G=self.K3
        assert_equal(sorted(G.neighbors_iter(0)),[1,2])
        assert_raises((KeyError,networkx_v099.NetworkXError), G.neighbors_iter,-1)
    ...
    def test_get_edge(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.get_edge,-1,0)
    ...
    def test_degree(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.degree,-1)
    ...
    def test_nbunch_iter(self):
        ...
        assert_raises(networkx_v099.NetworkXError,bunch.next) # but gets caught when iterator used
        bunch=G.nbunch_iter([0,1,2,{}])    # unhashable doesn't get caught upon creation of iterator
        assert_raises(networkx_v099.NetworkXError,list,bunch) # but gets caught when iterator hits the unhashable
