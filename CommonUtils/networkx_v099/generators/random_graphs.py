...
import math
import networkx
from networkx_v099.generators.classic import empty_graph, path_graph, complete_graph
...
def random_powerlaw_tree(n, gamma=3, seed=None, tries=100):
    ...
    """
    from networkx_v099.generators.degree_seq import degree_sequence_tree
    try:
...
def random_powerlaw_tree_sequence(n, gamma=3, seed=None, tries=100):
    ...
    # get trial sequence        
    z=networkx_v099.utils.powerlaw_sequence(n,exponent=gamma)
    # round to integer values in the range [0,n]
    zseq=[min(n, max( int(round(s)),0 )) for s in z]
    
    # another sequence to swap values from
    z=networkx_v099.utils.powerlaw_sequence(tries,exponent=gamma)
    # round to integer values in the range [0,n]
