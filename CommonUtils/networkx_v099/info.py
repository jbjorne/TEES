...
Networkx_For_Beg.  If you use such edge data, set Graph.weighted=False to avoid 
confusion.
...
The following shorthand is used throughout Networkx_For_Beg documentation and code:
