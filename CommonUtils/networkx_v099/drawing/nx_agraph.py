...
def from_agraph(A,create_using=None):
    """Return a Networkx_v099 Graph or DiGraph from a pygraphviz graph.
...
def to_agraph(N, graph_attr=None, node_attr=None, strict=True):
    """Return a pygraphviz graph from a Networkx_v099 graph N.
...
def read_dot(path,create_using=None):
    """Return a Networkx_v099 XGraph or XdiGraph from a dot file on path.
