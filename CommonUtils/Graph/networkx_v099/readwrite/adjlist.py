...
Read and write Networkx_v099 graphs as adjacency lists.

Note that Networkx_v099 graphs can contain any hashable Python object as
node (not just integers and strings).  So writing a Networkx_v099 graph
...
from networkx_v099.utils import is_string_like,_get_fh
import networkx
