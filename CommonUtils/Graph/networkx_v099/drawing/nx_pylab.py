...
References:
 ...
 - pygraphviz:     http://networkx_v099.lanl.gov/pygraphviz/
...
def draw(G, pos=None, ax=None, hold=None, **kwds):
    ...
    >>> import pylab as P
    >>> import networkx_v099 as NX
    >>> G=NX.dodecahedral_graph()

    and then use

    >>> NX.draw(G)  # networkx_v099 draw()
    ...
    """
    if pos is None:
        pos=networkx_v099.drawing.spring_layout(G) # default to spring layout
...
def draw_networkx_nodes(G, pos,
    ...
    try:
        ...
        raise networkx_v099.NetworkXError('Bad value in node positions.')
...
def draw_circular(G, **kwargs):
    ...
    from networkx_v099.drawing.layout import circular_layout
    draw(G,circular_layout(G),**kwargs)
    
def draw_random(G, **kwargs):
    """Draw the graph G with a random layout."""
    from networkx_v099.drawing.layout import random_layout
    draw(G,random_layout(G),**kwargs)

def draw_spectral(G, **kwargs):
    """Draw the graph G with a spectral layout."""
    from networkx_v099.drawing.layout import spectral_layout
    draw(G,spectral_layout(G),**kwargs)

def draw_spring(G, **kwargs):
    """Draw the graph G with a spring layout"""
    from networkx_v099.drawing.layout import spring_layout
    draw(G,spring_layout(G),**kwargs)

def draw_shell(G, **kwargs):
    """Draw networkx_v099 graph with shell layout"""
    from networkx_v099.drawing.layout import shell_layout
...
def draw_graphviz(G, prog="neato", **kwargs):
    """Draw networkx_v099 graph with graphviz layout"""
    pos=networkx_v099.drawing.graphviz_layout(G,prog)
    draw(G,pos,**kwargs)
