...
class TestMultiDiGraph(TestMultiGraph):
    def setUp(self):
        self.Graph=networkx_v099.MultiDiGraph
        # build K3
    ...
    def test_to_directed(self):
        G=self.K3
        H=networkx_v099.MultiDiGraph(G)
        assert_equal(G.pred,H.pred)
        assert_equal(G.succ,H.succ)
        H=G.to_directed()
        assert_equal(G.pred,H.pred)
    ...
    def test_successors(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.successors,-1)

    def test_successors_iter(self):
        G=self.K3
        assert_equal(sorted(G.successors_iter(0)),[1,2])
        assert_raises((KeyError,networkx_v099.NetworkXError), G.successors_iter,-1)
    ...
    def test_predecessors(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.predecessors,-1)

    def test_predecessors_iter(self):
        G=self.K3
        assert_equal(sorted(G.predecessors_iter(0)),[1,2])
        assert_raises((KeyError,networkx_v099.NetworkXError), G.predecessors_iter,-1)
    ...
    def test_in_degree(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.in_degree,-1)
    ...
    def test_out_degree(self):
        ...
        assert_raises((KeyError,networkx_v099.NetworkXError), G.out_degree,-1)
