...
class Preprocessor(ToolChain):
    ...
    def defineSteps(self):
        ...
        self.defStep("STANFORD_CONST", clsStep(StanfordParser, "parse"), {"parserName":self.parseName, "debug":False, "action":"penn"})
        self.defGroup("Dependency Parsing")
        self.defStep("STANFORD_DEP", clsStep(StanfordParser, "parse"), {"parserName":self.parseName, "debug":False, "action":"dep", "outputFormat":None})
        ...
        self.defStep("EXPORT_CHEMPROT", Utils.Convert.convertChemProt.exportChemProtPredictions, {"mode":"predictions", "setNames":{"train":"chemprot_training", "devel":"chemprot_development"}}, {"input":"xml", "output":"outPath"})
